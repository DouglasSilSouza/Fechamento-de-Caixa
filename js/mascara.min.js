function ResetCampos() {
  for (var o = document.getElementsByTagName("input"), e = 0; e < o.length; e++)
    "text" == o[e].type &&
      ((o[e].style.backgroundColor = ""), (o[e].style.borderColor = ""));
}
function coresMask(o) {
  ...
  0 == r
    ...
    : r < t
    ? ((o.style.borderColor = corIncompleta),
      (o.style.backgroundColor = corIncompleta))
    : ((o.style.borderColor = corCompleta),
      (o.style.backgroundColor = corCompleta));
}
  ...
  if (
    ...
    if (8 != id)
      for (
        ...
        i < c &&
        ("#" == o.substr(i, 1)
          ? ((e.value += a.substr(j, 1)), j++)
          : "#" != o.substr(i, 1) && (e.value += o.substr(i, 1)),
        8 == id || cursorfixo || l++,
        j != s + 1);
        i++
      );
